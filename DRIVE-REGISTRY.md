...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Home Desk** · `storage` | WD easystore — P/N `WDBKUZ0050BBK-…EA` | 5 TB | HDD | `WX21E6944029` | exFAT | top+label (3,4) | — |
| **Work Desk** · `Expansion` | Seagate Expansion HDD — `SRD0NF1`, P/N `3EAP9-500` | 4 TB | HDD | `NT199393E` | exFAT | top+label (7,8) | mfg 2022 |
...
| **Backup** · `timemachine` | WD **My Passport for Mac** — P/N `WDBLUZ0010BSL-03` | 1 TB | HDD | `WX61EC3HYY90` | HFS+ | lid+underside (5,6) | silver lid marker "TIME MACHINE / MacBook Pro backup" · underside "Double Scorpio" sticker |
