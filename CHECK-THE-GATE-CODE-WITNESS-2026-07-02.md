...
and `!/THRESHOLD-DOCTRINE` remain **ungated by CODEOWNERS**; the options I gave Logan (review #720
directly; split the doctrine edits out; add a CODEOWNERS rule — his surface, not mine) are his to
pick. The **live `main` branch protection** — whether PR #720 requires review to merge *at
