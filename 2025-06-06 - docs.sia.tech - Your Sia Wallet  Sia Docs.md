---
source: "https://docs.sia.tech/wallet/wallet-overview"
author:
...
Start storing your Siacoins on Sia by downloading the official [`walletd` software](https://sia.tech/software/walletd) and exploring our step-by-step [Setting up walletd](https://docs.sia.tech/wallet/setting-up-walletd) guide.
