---
source: "https://rpg.stackexchange.com/questions/164687/what-are-the-official-opposing-schools-of-magic"
author:
  - "[[NathanS 82.1k7373 gold badges416416 silver badges692692 bronze badges]]"
  - "[[guildsbounty 68k1313 gold badges260260 silver badges284284 bronze badges]]"
  - "[[NathanS – NathanS]]"
  - "[[L.P. – L.P.]]"
  - "[[Raven Dreamer – Raven Dreamer]]"
  - "[[KRyan 375k6161 gold badges988988 silver badges1.6k1.6k bronze badges]]"
  - "[[KRyan – KRyan]]"
  - "[[KorvinStarmast – KorvinStarmast]]"
  - "[[KorvinStarmast 147k3636 gold badges487487 silver badges801801 bronze badges]]"
  - "[[guildsbounty – guildsbounty]]"
...
Note that if this question makes most sense in 3.5e or something, the reason I've tagged it is because I don't know enough outside of 5e to even know what edition I'm talking about. So if the answer would be different between editions, I would ask that an answer points out these differences if it is realistic to do so.

[edited Jan 31 at 23:07](https://rpg.stackexchange.com/posts/164687/revisions "show all edits to this post")

[Thomas Markov](https://rpg.stackexchange.com/users/62294/thomas-markov)

155k 30 gold badges886 silver badges1.2k bronze badges

asked Feb 12, 2020 at 14:43

[NathanS](https://rpg.stackexchange.com/users/35259/nathans)

82.1k 73 gold badges416 silver badges692 bronze badges
...
[![enter image description here](https://i.sstatic.net/iu6hi.jpg)](https://i.sstatic.net/iu6hi.jpg)
...
[edited Jun 16, 2020 at 10:23](https://rpg.stackexchange.com/posts/164691/revisions "show all edits to this post")

[Community](https://rpg.stackexchange.com/users/-1/community) Bot

1

answered Feb 12, 2020 at 15:22

[guildsbounty](https://rpg.stackexchange.com/users/16358/guildsbounty)

68k 13 gold badges260 silver badges284 bronze badges
...
| Necromancy | Illusion | Enchantment/Charm <sup>3</sup> |

1. <sub>“Alteration” would be known as “Transmutation” today.</sub>
2. <sub>So-called “lesser divinations” were usable by everyone, and never opposed to anything.</sub>
3. <sub>The Enchantment/Charm school consisted not only of what we would consider Enchantments today—that was actually the Charm part—but also the manipulation of magic items, which is what Enchantment originally referred to. See <a href="https://rpg.stackexchange.com/a/89470/4563">this answer</a> for more details.</sub>

The forum post supposes this was done for game-balance reasons.

Anyway, the forum thread here is explicit about how these oppositions are often arbitrary and don’t make a whole lot of sense. That’s because this scheme was developed and imposed after the fact; the schools were originally developed without any such opposition in mind. So bear that in mind if you want to run with this: there isn’t really a great way *to* do it.

[edited Jan 26, 2021 at 1:01](https://rpg.stackexchange.com/posts/164689/revisions "show all edits to this post")

answered Feb 12, 2020 at 15:15

[KRyan](https://rpg.stackexchange.com/users/4563/kryan)

375k 61 gold badges988 silver badges1.6k bronze badges
...
While there are technically nine schools of magic in AD&D 2e, it boils down to the eight that we have in 5e since Lesser Divination is / was usable by all wizards with no restrictions. (Read Magic, Detect Magic, etc). (PHB, AD&D 2e, Magic, and *The Complete Wizard's Handbook*). My translation from AD&D 2e to 5e terms follows, so that I can make the table applicable to your [Red Wizard question](https://rpg.stackexchange.com/q/164685/22566).

My translation:  
Alteration = Transmutation for 5e.  
Evocation/Invocation = Evocation for 5e.  
Greater Divination = Divination for 5e.

With that in mind: the oppositional schools look like this:

> | School | Oppositional Schools |
> | --- | --- |
...
> | Greater Divination | Conjuration |
...
<sup>1</sup> And ended, since 3.x approached specialization a bit differently. WotC seems to have found (as many players did) that the oppositional schools approach didn't work particularly well.

[edited Jan 31 at 18:24](https://rpg.stackexchange.com/posts/164690/revisions "show all edits to this post")

[bobble](https://rpg.stackexchange.com/users/125559/bobble)

1,533 6 silver badges26 bronze badges

answered Feb 12, 2020 at 15:15

[KorvinStarmast](https://rpg.stackexchange.com/users/22566/korvinstarmast)

147k 36 gold badges487 silver badges801 bronze badges
