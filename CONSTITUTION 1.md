...
- **Chat is ephemeral. Vault is the record.** Durable decisions and context windows must be captured in vault.md.syntax.LF
- **Elevation governance: no instances gain higher "level" or "layer" access without Logan's explicit IRL approval.**
...
The five documentary C's align all work: capture, collect, collate, catalogue, [ ? ].
