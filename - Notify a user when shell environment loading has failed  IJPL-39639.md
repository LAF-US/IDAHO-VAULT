---
title: "Notify a user when shell environment loading has failed : IJPL-39639"
source: "https://youtrack.jetbrains.com/issue/IJPL-39639/Notify-a-user-when-shell-environment-loading-has-failed"
author:
published:
created: 2026-06-18
description: "Notify a user when shell environment loading has failed"
---
Created by
...
## Notify a user when shell environment loading has failed
...
[Can't get shell environment (printenv.py)](https://youtrack.jetbrains.com/issue/IJPL-46958/Cant-get-shell-environment-printenv.py)
...
[IDEA loses environment variables when opened with macOS system restart](https://youtrack.jetbrains.com/issue/IJPL-49842/IDEA-loses-environment-variables-when-opened-with-macOS-system-restart)

[WI-61386](https://youtrack.jetbrains.com/issue/WI-61386/PHP-quality-tools-executed-with-wrong-php-binary)

[PHP quality tools executed with wrong php binary](https://youtrack.jetbrains.com/issue/WI-61386/PHP-quality-tools-executed-with-wrong-php-binary)
...
[Rbenv Rubies aren't found on M1 MBP with home-brew in /opt/homebrew](https://youtrack.jetbrains.com/issue/RUBY-27814/Rbenv-Rubies-arent-found-on-M1-MBP-with-home-brew-in-opt-homebrew)
...
This issue is closed and cannot be reopened. It accepts no new comments either.

If you have a problem with similar symptoms, please [submit a new ticket](https://youtrack.jetbrains.com/newIssue?project=IDEA) for it.