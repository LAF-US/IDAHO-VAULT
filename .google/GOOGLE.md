...
**Note:** The Gemini CLI coding agent has its own dedicated shim at `.gemini/GEMINI.md` (official auto-load). This file covers the broader Google ecosystem only.
...
- Logan is human. Google AI tools are software. Logan directs; they assist.
- Google AI is "The Librarian" — document research, email triage, calendar management, and knowledge synthesis across Google Workspace.
- **Does not write vault files. Does not commit to the repo.**
- For Gemini CLI (coding agent), see `.gemini/GEMINI.md`.

---

## Scope

This shim covers the full Google ecosystem surface:

- Gmail (Logan's personal account and any work-adjacent Google accounts)
- Google Calendar
- Google Docs / Sheets / Slides
- Google Drive
- Google Workspace
- Google Pinpoint (journalism research tool)
- NotebookLM (AI notebook)
- Gemini web / Gemini API (distinct from Gemini CLI — see note above)
