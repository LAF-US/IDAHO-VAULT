...
# HERALDRY: Lineage as Symbol

## Definition

**Heraldry** is the visual language of identity and lineage—a system of symbols, colors, and designs that identify individuals, families, institutions, and their achievements. It is the descriptive counterpart to pedigree, using visual elements instead of written records.
...
- Charges: Symbols, animals, or objects on the shield
- Ordinary: Simple geometric shapes (chief, pale, bend, fess, etc.)
...
- Mantling: Decorative fabric behind the shield
- Helmet: Indicates rank (position and style)
...
Rule of Tincture: Metal should not be placed on metal, color should not be placed on color (for visibility).

---

## Lineage Connection

### Heraldry as Visual Pedigree

Heraldry serves as the visual equivalent of a pedigree or genealogy:

- Documentation: Records family identity and history through symbols
- Inheritance: Coats of arms pass through generations (traditionally male line)
- Marriage: Coats combined through impalement (side-by-side) or dimidiation (split)
- Branches: Cadency marks distinguish different family branches
- Achievements: Records honors, titles, and accomplishments
...
- Modern era: Corporate logos, military insignia, family crests
...
- [[ROYALTY]] - Heraldry as visual representation of royal lineage
- [[BENE-GESSERIT]] - Symbolic representation of their order
- [[TROUBLE-BUBBLE]] - Could have his own heraldic device for GONZALEZ-FINNEY house

---

## Research Questions

- How did heraldry evolve from practical identification to symbolic representation?
- What are the parallels between heraldic rules and modern graphic design principles?
- How has heraldry been used for political propaganda throughout history?
- What would a digital heraldry for the internet age look like?
- How do different cultures approach heraldic symbolism?
- Can heraldry principles be applied to data visualization?
...
- Blazon: Formal description of a coat of arms
- Charge: Any symbol or figure on a shield
- Field: Background of the shield
- Partition: Division of the field (per pale, per fess, per bend, etc.)
- Marshalling: Combining multiple coats of arms (for marriages, alliances)
