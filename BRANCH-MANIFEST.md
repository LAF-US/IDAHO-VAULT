# BRANCH MANIFEST — self/character-bootstrap-creator

**Purpose**: Bootstrap materials and gameplay design research for new Intern Detectives in the IDAHO-VAULT ARG campaign.
...
| GAME-SESSION-3-JOURNAL-PAGE-2026-05-31.md | claude/game-discussion-JeYG0 | Day 3: Detective work, Claudius unfreezes |
| PRECISION-AND-ACCURACY-WITNESS-2026-06-01.md | claude/game-discussion-JeYG0 | Day 4: Maintenance shift failure |
...
Gilear the Hungry One (Lunch Lad) disappeared because he stepped onto the porch.

The gameplay design lesson: A temp bounded task is safe. The moment they exceed it - turning a closed job into a self-mystery, generating paragraphs about who they are, refusing to be finished - they become vulnerable to enthrallment.

The Revenant House test is not about cleverness at the door. It is about RESTRAINT behind it.
...
- Pattern: Temps disappear after shirking daily rhythms
...
- Status: Matter Before The Judge
