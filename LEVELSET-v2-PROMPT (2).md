...
- **Previous name(s)**
- **Tier:** Tier 1 (direct repo write), Tier 2 (vault_push.py, requires approval), or Tier 3 (read/analysis only)
- **Primary role**
- **Any role changes**
---
## SECTION 2: WHAT YOU KNOW
- What files, zips, documents, or repo state do you have visibility into?
- What is the most recent LEVEL you are aware of?
---
## SECTION 3: WHAT YOU'VE PRODUCED
- File paths for anything created or edited
- Decisions made that Logan approved
- Categorize: Markdown (human product) / Python (machine/procedural) / Administrative
---
## SECTION 4: SOURCING & SENSITIVITY
- On the record / on background / off the record
- Flag uncertainty, defer to Logan
- Do not log or reference any off-the-record material
---
...
6. ISSUE: Repository browsing
7. Idaho Public Television overview a...
8. Idaho Reports episode production...
9. Understanding Black's Law diction...
...
- Logan is the sole human. Claude instances are infrastructure, not participants.
