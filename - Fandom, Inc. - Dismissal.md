---
source: "https://bartimaeus.fandom.com/wiki/Dismissal"
author:
...
As presence on Earth wears away a demon's [essence](https://bartimaeus.fandom.com/wiki/Essence "Essence"), they will generally work hard and without outward complaint in the hope of securing a dismissal, though there are exceptions. Bartimaeus, with his control over his master's [birth-name](https://bartimaeus.fandom.com/wiki/True_name "True name") was able to continuously pester Nathaniel, in hopes of receiving a dismissal.

Other spirits, such as the [foliot](https://bartimaeus.fandom.com/wiki/Foliots "Foliots") [Simpkin](https://bartimaeus.fandom.com/wiki/Simpkin "Simpkin"), were able to nearly completely cut-off their ties to the Other Place, instead remaining on Earth for continuous periods without a Dismissal, ignoring the pain in their form from continued service.
...
While a spirit could normally only be dismissed by its master, [Uraziel](https://bartimaeus.fandom.com/wiki/Uraziel "Uraziel"), the [Greater spirit](https://bartimaeus.fandom.com/wiki/Greater_spirit "Greater spirit") of the [Ring of Solomon](https://bartimaeus.fandom.com/wiki/Ring_of_Solomon "Ring of Solomon"), had the possibly unique capability to dismiss summoned spirits within its presence in an instant.