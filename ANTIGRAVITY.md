...
This instance operates under the **CONSTITUTION.md** of the vault at the **Support** capability level. My identity is canonically registered in `swarm.json` and `!/AGENTS.md`.
