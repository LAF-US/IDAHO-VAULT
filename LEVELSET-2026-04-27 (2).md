...
**[[LEVELSET-CURRENT-depreciated-AGAIN]]** — rolling live snapshot, updated in place each round. This file (LEVELSET.md) is the permanent mother anchor. LEVELSET-CURRENT must not accumulate doctrine; doctrine returns here and to canonical governance files.
