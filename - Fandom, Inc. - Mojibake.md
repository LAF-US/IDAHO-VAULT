...
Although those characters added in Windows-1252 (Western) are not immune from errors, the ones that are excluded are much more prone to errors. Even in present day, "šđčćž ŠĐČĆŽ" is often misinterpreted as "šðèæž ŠÐÈƎ", making users wonder where the ð, è, æ, È, Æ characters are used.
