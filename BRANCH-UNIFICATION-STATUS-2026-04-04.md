...
- Default branch: main
- Method: merge-base ancestor check against origin/main

## Summary

- Merged into main: 25
- Unmerged into main: 0

## Branches Already Merged

- bot/daily-rollover-2026-04-04
- claude/allow-force-push-to-main
- claude/friendly-cartwright
- claude/repo-size-compliance-5accf9
- codex/create-manifest.json-specification-and-guidelines
- codex/fix-high-priority-bug-in-vault-update
- codex/fix-high-priority-bug-in-vault-update-25to8k
...
- codex/update-branch-protection-rules
- copilot/help-logan-overwhelmed
- vault-moves-2026-03-30

## Notes

- No branch deletions performed.
- Branch count in GitHub can remain high even when all branches are merged.
