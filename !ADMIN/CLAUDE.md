# IDAHO-VAULT — Shared Constitution

This file governs all Claude Code conversations operating on this repository. Every conversation — regardless of tier, type, or model — must read and comply with this document.
...
Conversations are named with a type prefix:
...
*Created 2026-03-15 by PUBLIC CONVERSATION SETUP conversation. This is the first shared constitution for the vault.*
