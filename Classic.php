						...
						<div id="libsyn-primary-media-settings">
							<div id="libsyn-new-media-settings">
								...
								<p>
									...
									<button class="button button-primary libsyn-dashicions-wordpress" id="libsyn-open-media" title="<?php echo esc_attr__( 'Click Here to Open the Media Manager', $plugin->text_dom ); ?>" onClick="libsynSelectImage(event)"><?php echo __( 'Select Wordpress Media', $plugin->text_dom ); ?></button>
									<button class="button button-primary libsyn-dashicions-cloud" id="libsyn-open-ftp_unreleased" title="<?php echo esc_attr__( 'Click Here to Open the Media Manager', $plugin->text_dom ); ?>" onClick="libsynSelectFtp(event)"><?php echo __( 'Select ftp/unreleased', $plugin->text_dom ); ?></button>
								</p>
								<p>
					  ...
					  <td>
						<div id="libsyn-primary-media-settings">
							<div id="libsyn-new-media-settings">
								...
								<button class="button button-primary libsyn-dashicions-image" id="libsyn-open-image" title="<?php echo esc_attr__( 'Click Here to Open the Image Manager', $plugin->text_dom ); ?>" onClick="libsynSelectImage(event)"><?php echo __( 'Select Episode Thumbnail', $plugin->text_dom ); ?></button></p>
								<p>
