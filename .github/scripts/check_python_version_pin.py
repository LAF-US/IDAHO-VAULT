...
def _repo_root() -> Path:
    ...
    # (trusted-main/), while .python-version and pyproject.toml under test
    # are the PR head's. Read from GITHUB_WORKSPACE (the primary checkout)
    # instead of the script's own tree, or a PR-head-only edit would be
    ...
    if os.environ.get("GITHUB_ACTIONS") == "true":
        ...
        # IDAHO-VAULT checkout before trusting it as a path root, rather than
