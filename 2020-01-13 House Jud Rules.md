...
Custody is defined in Idaho statute; requires contact with both parents unless court finds evidence for otherwise. Joint custody is presumed in child’s best interest, requires evidence for sole custody. Sole custody can be issued on single topics like schooling or activities when parents are at odds.
...
LSO analysis is linked, or the Office has side-by-side analysis available
