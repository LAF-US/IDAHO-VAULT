...
Family Law – presentation by Magistrate [[judges]]

**[[5th Judicial District]] judge [[Rick Bollar]] of [[Minidoka County]]**
...
5% or less of [[family court]] cases go to full-day trials, most are simply hearings etc.

Shortest amount of time to schedule a full-day trial: 60 days. More likely 6 months.

Custody is defined in [[Idaho Code|Idaho statute]]; requires contact with both parents unless court finds evidence for otherwise. Joint custody is presumed in child’s best interest, requires evidence for sole custody. Sole custody can be issued on single topics like schooling or activities when parents are at odds.

Shared/Split custody – circumstances where both of the parents use resources for the children in different proportions
...
Judge stands for questions – (22:30)

Guardian expresses child’s best interest vs Attorney expresses child’s wishes

Grandparents visitation – also guided by code, can be considered

FAMILY LAW RULES – (24:20) previously in rules of civil procedures, self-represented litigants had difficulty navigating, this makes it easier for them, has forms attached. Because so many are representing themselves.
...
5 ½ year old commission, in early days was only for training

2015 [[ACLU of Idaho]] lawsuit – constitutional requirements

Since 2016 – commission responsibilities have included training, data collection, model contracts, passthrough funding for counties, oversight,

Commission is tasked with system change, not individual cases or attorneys

Rules changes: will rewrite [[administrative rules]] for next session.

Today: no substantive changes (redundant intros, consolidated definitions). “grant” -> “financial assistance”

47:00 on changing grant to financial assistance: counties were concerned bc “grants” were seen as temporary. No actual functional policy change.

[[Doug Ricks]] (48:00) – concern that there are no comparative notes like in other committees…

[[Legislative Services Office|LSO]] analysis is linked, or the Office has side-by-side analysis available
...
[[Ryan Kerby]] moves to introduce.

[[Bryan Zollinger]]: any savings that aren’t reflected in fiscal note? $300,000 to set up.
Troy: state has already invested in the system. It exists, but isn’t being fully used. Bill brings this data into that existing system.

[[Gary Marshall]]: why do we need the system?
Troy: all the criminal data is siloed between various agencies, can’t compare and get a complete picture. [[State Controller]] has a data system.

Zollinger (1:10:00) - “Contributing agency” ?
