...
== Changelog ==
= 1.2.2.9 =
* Fixed issues causing some block editor functionality not to work properly.

= 1.2.2.8 =
* Small bug fix for php > 5.6 compatibility.

= 1.2.2.7 =
* Some style sheet changes.
* Feed importer process changes.
* Feed importer compatibility bug fixes.
* Testing up to Wordpress 5.4.x
* Fixed bug causing media uploader to not function using the Block Editor.
