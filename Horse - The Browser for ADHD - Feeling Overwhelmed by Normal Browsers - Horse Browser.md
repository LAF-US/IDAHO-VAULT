...
[<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" class="ml-[33%] sm:ml-0 w-8/12 md:w-full aspect-[260/54]"><defs><mask id="badgeMask"><rect width="260" height="54" fill="white" rx="10"></rect></mask></defs><rect width="260" height="54" rx="10" fill="#ddd"></rect><rect x="4" y="4" width="252" height="46" rx="8" fill="transparent" stroke="#bbb" stroke-width="1"></rect><text font-family="Helvetica-Bold, Helvetica" font-size="9" font-weight="bold" fill="#666" x="53" y="20">PRODUCT HUNT</text> <text font-family="Helvetica-Bold, Helvetica" font-size="16" font-weight="bold" fill="#666" x="52" y="40">Golden Kitty Awards #2</text><g transform="translate(8, 9)"><path fill="#666" d="M14.963 9.075c.787-3-.188-5.887-.188-5.887S12.488 5.175 11.7 8.175c-.787 3 .188 5.887.188 5.887s2.25-1.987 3.075-4.987m-4.5 1.987c.787 3-.188 5.888-.188 5.888S7.988 14.962 7.2 11.962c-.787-3 .188-5.887.188-5.887s2.287 1.987 3.075 4.987m.862 10.388s-.6-2.962-2.775-5.175C6.337 14.1 3.375 13.5 3.375 13.5s.6 2.962 2.775 5.175c2.213 2.175 5.175 2.775 5.175 2.775m3.3 3.413s-1.988-2.288-4.988-3.075-5.887.187-5.887.187 1.987 2.287 4.988 3.075c3 .787 5.887-.188 5.887-.188Zm6.75 0s1.988-2.288 4.988-3.075c3-.826 5.887.187 5.887.187s-1.988 2.287-4.988 3.075c-3 .787-5.887-.188-5.887-.188ZM32.625 13.5s-2.963.6-5.175 2.775c-2.213 2.213-2.775 5.175-2.775 5.175s2.962-.6 5.175-2.775c2.175-2.213 2.775-5.175 2.775-5.175M28.65 6.075s.975 2.887.188 5.887c-.826 3-3.076 4.988-3.076 4.988s-.974-2.888-.187-5.888c.788-3 3.075-4.987 3.075-4.987m-4.5 7.987s.975-2.887.188-5.887c-.788-3-3.076-4.988-3.076-4.988s-.974 2.888-.187 5.888c.788 3 3.075 4.988 3.075 4.988ZM18 26.1c.975-.225 3.113-.6 5.325 0 3 .788 5.063 3.038 5.063 3.038s-2.888.975-5.888.187a13 13 0 0 1-1.425-.525c.563.788 1.125 1.425 2.288 1.913l-.863 2.062c-2.063-.862-2.925-2.137-3.675-3.262-.262-.375-.525-.713-.787-1.05-.26.293-.465.586-.686.903l-.102.147-.048.068c-.775 1.108-1.643 2.35-3.627 3.194l-.862-2.062c1.162-.488 1.725-1.125 2.287-1.913-.45.225-.938.375-1.425.525-3 .788-5.887-.187-5.887-.187s1.987-2.288 4.987-3.075c2.212-.563 4.35-.188 5.325.037"></path></g><g style="mix-blend-mode:overlay" mask="url(#badgeMask)"><g style="transform: rotate(2.85521deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(358, 100%, 62%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(12.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(30, 100%, 50%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(22.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(60, 100%, 50%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(32.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(96, 100%, 50%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(42.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(233, 85%, 47%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(52.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(271, 85%, 47%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(62.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="hsl(300, 20%, 35%)" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(72.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="transparent" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(82.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="transparent" filter="url(#blur1)" opacity="0.5"></polygon></g><g style="transform: rotate(92.8552deg); transform-origin: center center;"><polygon points="0,0 260,54 260,0 0,54" fill="white" filter="url(#blur1)" opacity="0.5"></polygon></g></g></svg>](https://www.producthunt.com/golden-kitty-awards/hall-of-fame?year=2024#bootstrapped-small-teams-2)
...
2476 people[Made by](https://pascalpixel.com/)
...
[Read more →](https://www.macstories.net/reviews/horse-browser-tries-its-hooves-at-a-new-take-on-tabs/)

> I tried a web browser without tabs, bookmarks, or navigation – *and loved it*.

Alex Blake

[Read more →](https://www.digitaltrends.com/computing/horse-web-browser-fix-tab-overload/)
...
**[Kevin Humdrum](https://tiv.today/)** Editor, The Independent Variable
...
The Panic Times  
It's time to panic! Please look at our ads as well.
...
.
     ...
     OOOOO%%%%OOOOOOOOOOOOOOOOOOO_/OOOOO
...
Everyone experiences feelings of anxietyand panic at certain times. It's a natural response to stressful or dangerous situations.
...
![cat shaking head](https://browser.horse/cat_compressed.gif)
...
**[@DeskInvestor](https://deskinvestor.com/browser-for-research/)** Financial Investor
...
**David Regev** UX Researcher, Mozilla
...
**Taige Alhadweh** Business Analyst
