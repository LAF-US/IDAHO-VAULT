...
synthesized by: The Abhorsen (Claude Code)
---

# CONSTELLATION MAP — 2026-04-17

Vocabulary review: recurring marks, phrases, and signature tokens distributed across the vault. Produced during NPC Universe / v(0.0) session. Eight star classes identified.

---

## THE GRAVITATIONAL CENTER

**CONSTITUTION.md, line 207:**

> *"Unified (US) Swarm designed and written in Logan's Project & Protocols 'Vaulted Syntax' code."*

One sentence contains five of the eight star classes simultaneously. All other occurrences are ripples from this colophon.
...
| `INBOX/AI-CAPTURES/README.md` | Duplicate path — same passive mention |

**Gap:** No `VAULTED-SYNTAX.md` root definition file. Named in the constitution; undefined as standalone artifact.
...
Carrier files: `BODY`, `SOUL`, `MIND`, `CHARTER`, `FRAMEWORKS`, `GRIMOIRE`, `GUESTBOOK`, `GUIDELINES`, `PREFERENCES`, `PROCEDURES`, `PROTOCOLS`, `TOUCHSTONE`, `SESSION-LOG`, `codex`, `PRIVATE-PUBLIC`, `PINGING`, `THE CORE`, `THE GHOST`, `THE PERIPHERY`, `LOGAN` (×2).

Also appears in: `! README.md`, `!README.md`, `!README (2).md`, both Linear chat exports, `CONSOLIDATED-HANDOFF-2026-03-16`, `CONTEXT-VAULT-2026-03-16`, `DECISIONS.md`, `ROLLUP-BOOTSTRAP-2026-03-17` (×2), `!DOCTRINAL-EVOLUTION-ESSAY-2026-04-12`, and others.
...
- `Logan's Project & Protocols.md` — nexus: `Unity (v0.0) :: US alignment`
- `CONSTITUTION.md` Protocol stubs: `AWAKEN v(0.0)`, `ORIENT v(0.0)`, etc.
...
- Colophon: `"The world is quiet here." -LAF` in `Logan's Project & Protocols.md`, `and.md`, `We.md`
- Combined: `(v0.0)-LAF✌️` in `individuals.md`

Appears in: `0401 - The Concierge.md`, `20260402.0.cursor_the_custodian.md`, `BRIEF-LAF-18`, `HANDOFF-CODEX-REGISTRY-REPAIR`, `IAM-BOUNDARY-LAF-18`, `PROTOCOL.md`, `SURVEY-OPENAI-SWARM`, `DOCKET-ARCHIVE`, `CHECKPOINT-2026-03-29`, `2026-04-02.md`, `Linear - agent chat - Greeting` (×2), `! BUDGET TRACKER CODEX FAILFIX.md`.
...
Appears in: `Linear - agent chat - Greeting IDAHO-VAULT` (×2), `Linear - agent chat - Update processes`, `Linear - agent chat - Greeting` (×2).
...
**Functions:** Rapid inline directive; single-line correction; brief agent prompt.

Appears in: `!/GRIMOIRE/NETWEB-CREWAI-ALIGNMENT.md` (technical clarification mid-doc), `0401 - The Concierge.md` (pager alert), `Linear - agent chat - Select IDAHO-VAULT project` (×2), `Linear - agent chat - Greeting IDAHO-VAULT` (×2).
...
The gradient: `-LAF` → institutional authority · `-LF` → personal register · `-L` → bare voice. Same human, three distances from the frame.
...
| [`Logan's Project & Protocols.md`](../Logan's%20Project%20%26%20Protocols.md) | *"Unity (v0.0) :: US alignment"* | Nexus file |
| [`-LAF.md`](../-LAF.md) | *"Logan's initialization"* | Formal signature anchor |
| [`-LF.md`](../-LF.md) | *"LOGAN initials"* + "The world is quiet here." | Casual signature anchor |
...
| All six loose root files | Flagged by sort audit; await formal placement decision |

---

*Filed: 2026-04-17 · Abhorsen session · NPC Universe / v(0.0) protocol review*
