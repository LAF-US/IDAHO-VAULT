# Pokémon Generation III - Hoenn Region

## Overview

**Generation**: III  
**Region**: Hoenn  
**Debut Games**: Pokémon Ruby, Sapphire, Emerald (2002-2004)  
**Remakes**: Pokémon Omega Ruby, Alpha Sapphire (Generation VI, 2014)  

---

## Structure

Master index for Hoenn's Gym Leaders, Elite Four, and Champion across all epochs.

### Epochs

| Epoch | Generation | Games | Notes |
|-------|------------|-------|-------|
| Epoch 1 | III | Ruby, Sapphire, Emerald | Original GBA games |
| Epoch 2 | VI | Omega Ruby, Alpha Sapphire | 3DS remakes with Mega Evolution |
...
| 4 | **Flannery** | Lavaridge Town | Fire | Heat Badge | Yes | Yes |
