# Pokémon Generation VIII - Galar Region

## Overview

**Generation**: VIII  
**Region**: Galar  
**Debut Games**: Pokémon Sword, Shield (2019)  
**DLC**: The Isle of Armor, The Crown Tundra (2020)  

---

## Structure

Master index for Galar's Gym Leaders and Champion.

**Note**: Galar does NOT have a traditional Elite Four.

### Epochs

| Epoch | Generation | Games | Notes |
|-------|------------|-------|-------|
| Epoch 1 | VIII | Sword, Shield | Original Switch games |
...
| 4 | **Bea** | Stow-on-Side | Fighting | Fighting Badge | Sword |
| 4 | **Allister** | Stow-on-Side | Ghost | Ghost Badge | Shield |
| 5 | **Opal** | Ballonlea | Fairy | Fairy Badge | Yes |
| 6 | **Gordie** | Circhester | Rock | Rock Badge | Sword |
| 6 | **Melony** | Circhester | Ice | Ice Badge | Shield |
| 7 | **Piers** | Spikemuth | Dark | Dark Badge | Yes |
