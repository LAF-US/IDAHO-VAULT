...
**Lt. Surge** (Japanese: マチス *Matisse*) is the **Gym Leader of Vermilion City** in the **Kanto region**. He specializes in **Electric-type Pokémon** and awards the **Thunder Badge**.

- **Full Name**: Lt. Surge
- **Japanese Name**: Matisse (マチス)
- **Gym**: Vermilion Gym
- **Specialty**: Electric-type Pokémon
- **Badge**: Thunder Badge
- **First Appearance**: Pokémon Red and Blue (1996-1998)
- **Distinction**: Third Gym Leader in Kanto; military background
...
- **Notable**: Ash's Pikachu defeats his Raichu; first actual Gym win
