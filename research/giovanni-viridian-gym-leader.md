...
**Giovanni** (Japanese: サカキ *Sakaki*) is the **Gym Leader of Viridian City** in the **Kanto region** and the **boss of Team Rocket**, the first villainous team in the Pokémon series.

- **Full Name**: Giovanni
- **Japanese Name**: Sakaki (サカキ)
- **Gym**: Viridian Gym
- **Specialty**: Ground-type Pokémon
- **Badge**: Earth Badge
- **First Appearance**: Pokémon Red and Blue (1996-1998)
- **Role**: Dual role as Gym Leader and criminal organization leader
- **Distinction**: Only character to hold both a Gym Leader position and lead a villainous team
...
- **Pokémon Masters EX**: Sync Pair with Persian
...
- **Notable**:
  ...
  - Mewtwo Strikes Back: Commissioned Mewtwo's creation
  - Pokémon Generations: Shows Team Rocket operations
...
- Frustrated with Team Rocket's failures
...
- Blue takes over Viridian Gym after Giovanni leaves
- Team Rainbow Rocket in USUM
...
- Mewtwo connection
- Permanent resignation as Gym Leader
- Agatha temporarily takes over Viridian Gym
