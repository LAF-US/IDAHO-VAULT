...
**Trace** (Japanese: シン *Shin*) is the **rival character** and **Pokémon Champion** in Pokémon: Let's Go, Pikachu! and Let's Go, Eevee!. He serves as the final obstacle for trainers at the Indigo Plateau, analogous to Blue's role in the Generation I games.

- **Full Name**: Trace
- **Japanese Name**: Shin (シン)
- **Role**: Rival / Champion (Let's Go only)
- **Specialty**: Mixed-type team
- **First Appearance**: Pokémon: Let's Go, Pikachu! and Let's Go, Eevee! (Generation VII)
- **Distinction**: Childhood friend of the player, replaces Blue as Champion
...
- Competitive: Enjoys challenging trainers to battles
...
- Can be rematched after losing Champion title
- Team features diverse types similar to Blue's
