---
source: "https://bartimaeus.fandom.com/wiki/Scrying_Glass"
author:
...
Like most magical items, a proper scrying glass is created by simply entrapping a [spirit](https://bartimaeus.fandom.com/wiki/Spirit "Spirit") within a glass. A scrying glass, therefore, would require some form of smooth, visible surface for seeing visions in. The spirit, usually merely an [imp](https://bartimaeus.fandom.com/wiki/Imp "Imp"), appears within the surface of the glass for the [magician](https://bartimaeus.fandom.com/wiki/Magician "Magician") to relay instructions to, and then materialises wherever the magician orders it to. (The only time that this such materializing is shown is when the imp appears between a curtain of golden sparks resembling faerie dust after locating [Bartimaeus](https://bartimaeus.fandom.com/wiki/Bartimaeus "Bartimaeus")). The spirit has a limited rang

![Nathaniel/John Mandrake's Scrying Glass](https://bartimaeus.fandom.com/wiki/Scry.jpg)
...
- The glass can be stolen (like what happened to [Nathaniel](https://bartimaeus.fandom.com/wiki/Nathaniel "Nathaniel") 's in the first book), and the user/creator would have to get it back by themselves.
