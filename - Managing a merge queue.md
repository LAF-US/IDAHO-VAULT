...
published:
created: 2026-06-30
description: "You can increase development velocity with a merge queue for pull requests in your repository."
---
## About merge queues
...
A merge queue may use GitHub Actions or your own CI provider to run required checks on pull requests in a merge queue. For more information, see [GitHub Actions documentation](https://docs.github.com/en/actions).
