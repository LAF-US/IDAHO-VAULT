...
1. Clone the sample plugin using Git.
...
1. Compile the source code. The following command keeps running in the terminal and rebuilds the plugin when you modify the source code.
...
1. In the `onload()` method, add the following code:
...
1. In the **Command palette**, select **Reload app without saving** to reload the plugin.
