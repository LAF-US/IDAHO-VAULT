...
doc_class: sources
status: filed
subject: Evolution of book forms, materials, and binding techniques
tags:
  - sources
  - book-history
  - codex
...
# Sources - Book Forms, Materials, and Binding - 2026-06-03

## Scope

Source note for the 2026-06-03 answer on the evolution of book forms, including
materials and binding techniques. This note records sources used and short
observations. It is not doctrine.

## Local Vault Anchor

1. `!/BOOKS-OF-NAMES-AND-THE-PRESS-2026-04-17.md`
   - Used for the Vault-local framing that binding is the act of pressing
     canonical form into permanence, and that unbound sheets are a technical
     state rather than necessarily an incomplete state.
...
- Each book form solves three linked problems: writing surface, sequence, and
  transport/storage.
- Clay tablets solve inscription and durability, not portability.
- Scrolls solve sequence and portability, but make random access difficult.
- The codex solves random access, two-sided use, and multi-text aggregation.
- Binding evolves from sewing support to industrial casing and adhesive
  binding.
