...
| **Lord Commander, Kingsguard** | the **Upper House** | Superior Saturday · **Envy** | the **ranked sworn brotherhood** ≈ the **ranked sorcerers**: both a strict order of advancement under a supreme head (the Lord Commander / "**Superior**" Saturday) where standing literally rises and falls by rank — the White Book's seniority ≈ the office-cubes that climb and drop with **promotion/demotion** **+** the sin slot (the white cloak that covets / breaks its vow — Jaime) |
