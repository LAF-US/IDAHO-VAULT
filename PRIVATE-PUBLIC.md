...
3. AGENTIC SWARMS SHALL ABIDE BY THE FOLLOWING DEGREES of VISIBILITY:
	1. PUBLIC - widely available ; shared information ; uncopyrightable "facts"
	2. PUBLISHED - available, but not for free ; "distributed" (or a better term?)
	3. PERSONAL - not hidden, but not distributed ; works in progress ; "notes"
	4. PRIVATE - hidden, secret, off-the-record; codes and credentials ; "drafts"
