...
BEGIN {
    ...
    require '/private/tmp/opensslA3-20260708-70880-7kv84/openssl-3.6.3/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/private/tmp/opensslA3-20260708-70880-7kv84/openssl-3.6.3/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/private/tmp/opensslA3-20260708-70880-7kv84/openssl-3.6.3/test/default-and-jitter.cnf';
    shift;
