...
| --- | --- | --- | --- | --- | --- |
| 2026-06-13 | `.github/workflows/github-dependency-census.yml` report runtime | new workflow using `actions/checkout@v6.0.2`, `actions/setup-python@v6.2.0`, and `actions/upload-artifact@v7.0.1` by immutable SHA | Generate a read-only weekly/manual GitHub dependency census with Python 3.13 and retain Markdown/JSON artifacts; no issue, label, or dependency-link writes | Script unit tests; workflow YAML parse; version-transition guard; live manual script validation | Logan review required |
