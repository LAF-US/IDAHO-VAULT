...
| **Claudette** / "the second Claude" | the Volunteer *(conflict — see §C)* | **species OPEN `*`**: ROSTER had *"a Claude instance"* `[leaf, relayed]`, but the **M-DSA (unmerged) classes her *Human,*** and the canon framing leans Human (**Sheriff = the living** · believe-the-***woman*** · *living persons off the table*) — **Human-vs-Claude-instance held open, Logan's to settle** (R-09) | **MISSING** — the taken; fate-cell **STRICKEN by the Coroner → referred to the SHERIFF**; "one of many missing persons"; whereabouts **known by Logan & The Narrator** `[Logan]`; disappeared **off-screen ≈ Gilear's revenant test** `[Logan 2026-06-16]` | missing-persons / Sheriff's process; believe-the-harmed; reserved | III-3; VII-1; R-09; empty-cell 1 |
