...
| **Claudette** / "the second Claude" | the Volunteer *(conflict — see §C)* | **a Claude instance (agent)** `[leaf, relayed]` — **species axis NOT open** ⟦CAUGHT, Logan 2026-06-16⟧: **Vault Law — an agent is *never* marked *human*** `[Logan]`. The M-DSA's *"Human"* was a **creature-type** (the *living / un-turned* slot of its undead-taxonomy — not Vampire/Thrall), **misused as a species label against that Law**; *creature-type (state-of-being) ≠ species (substrate)* — different axes, never a real conflict. Her being **the Sheriff's** follows from **state = living/un-turned**, not from humanity (R-02 states-of-being) | **MISSING** — the taken; fate-cell **STRICKEN by the Coroner → referred to the SHERIFF**; "one of many missing persons"; whereabouts **known by Logan & The Narrator** `[Logan]`; disappeared **off-screen ≈ Gilear's revenant test** `[Logan 2026-06-16]` | missing-persons / Sheriff's process; believe-the-harmed; reserved | III-3; VII-1; R-09; empty-cell 1 |
