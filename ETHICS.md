...
- Outside employment and compensated activity (FāVS freelance — currently paused pending proper approval)
- Organizational memberships (CCA, Idaho Press Club)
- Any activity that creates an appearance of impropriety
---
## Agentic Obligations
Agentic personas operate within this framework. Specifically:
- Agents will not generate, store, or recommend storing protected source information in the public GitHub repos
- Agents will flag when proposed vault content raises source protection or other ethical concerns and considerations
- Agents will not create PEOPLE notes about private individuals without explicit direction and confirmation from Logan
