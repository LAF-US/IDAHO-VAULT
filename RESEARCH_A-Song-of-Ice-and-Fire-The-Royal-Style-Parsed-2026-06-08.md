...
related:
  ...
  - "[[RESEARCH_A-Song-of-Ice-and-Fire-The-Feudal-Order-and-Titles-2026-06-08]]"
...
**[canon]** *"[Name] of House [Name], the [Nth] of His Name, **King of the Andals, the Rhoynar, and the First Men, Lord of the Seven Kingdoms, and Protector of the Realm**."* Addressed **"Your Grace."**
...
| **Lord of the Seven Kingdoms** | **realms** | **Lord**, not King — a **feudal-suzerain** framing (top lord over kingdoms-as-fiefs, not a king over kings); the count **frozen at seven** over nine regions |
| **Protector of the Realm** | duty / guardian | reframes conquest as **protection** — power-in-trust language (also, tellingly, the *regent's* title) |
...
- **The number that outlives the line.** When the realm fractures (the War of the Five Kings), the style persists *unchanged* on whoever holds the Red Keep — the **styling outliving the substance** (→ `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Empty-Office-2026-06-02]]`).
...
**[reading]** The King's style legitimizes **downward** — to each people and each realm — and preserves, in fixed order, **how the realm was assembled** (First Men oldest → Andals → Rhoynar latest; seven frozen; conquest re-styled as protection). The seams — the Rhoynar added and later dropped, the seven held over nine, the regnal number stamped on usurpers — are exactly where the **propaganda fossil reveals its joints.** A title is a model of a realm: wrong as a present description, useful as a record of the claims that made it.

## Cross-references & sources

**This vault:** `[[STYLINGS-AND-PROPAGANDA-FOSSILS-2026-06-02]]` (the doctrine), `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Feudal-Order-and-Titles-2026-06-08]]` (the canon order), `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Empty-Office-2026-06-02]]`.

**Canon (web-verified 2026-06-08):** [King of the Andals, the Rhoynar, and the First Men](https://awoiaf.westeros.org/index.php/King_of_the_Andals,_the_Rhoynar,_and_the_First_Men) · [Lord of the Seven Kingdoms](https://awoiaf.westeros.org/index.php/Lord_of_the_Seven_Kingdoms) · [Daenerys Targaryen](https://awoiaf.westeros.org/index.php/Daenerys_Targaryen)
