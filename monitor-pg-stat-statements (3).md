...
dv_total_exec_time: numeric, 2
dv_mean_exec_time: numeric, 2
---
...
select
  calls,
  roundtotal_exec_time = `= this.dv_total_exec_time` as total_time_ms,
  roundmean_exec_time = `= this.dv_mean_exec_time` as mean_time_ms,
  query
