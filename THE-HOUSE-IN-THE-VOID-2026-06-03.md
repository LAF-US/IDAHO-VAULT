...
> **Provenance.** *Keys to the Kingdom* (Nix) and *Hades / Hades II* (Supergiant) **verified by web research 2026-06-03** (⚠️ Hades II early-access; Keys via search extracts, 403s). ASOIAF grounded in the linked nodes. Vault doctrine read (`EMANATIONISM`, `LICH-PROBLEM`). Tiers: **[canon-per-system]**, **[reading]**. ⚠️ Keys & Hades are **not yet in the `FANDOM-CANON-RULESYSTEMS` registry** — candidates. Paraphrased; no source text reproduced.
