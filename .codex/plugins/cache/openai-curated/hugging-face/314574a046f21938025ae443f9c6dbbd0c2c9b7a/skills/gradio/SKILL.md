...
- **Audio**: stream, change, clear, play, pause, stop, pause, sta***REMOVED***recording, pause_recording, stop_recording, upload, input
...
- **HTML**: change, input, click, double_click, submit, stop, edit, clear, play, pause, end, sta***REMOVED***recording, pause_recording, stop_recording, focus, blur, upload, release, select, stream, like, example_select, option_select, load, key_up, apply, delete, tick, undo, retry, expand, collapse, download, copy
...
- **Video**: change, clear, sta***REMOVED***recording, stop_recording, stop, play, pause, end, upload, input
