...
def sanitize_dataset(dataset, bbox_format="xywh", image_col="image", objects_col="objects"):
    ...
    """
    conve***REMOVED***xyxy = bbox_format == "xyxy"
...
def conve***REMOVED***bbox_yolo_to_pascal(boxes: torch.Tensor, image_size: tuple[int, int]) -> torch.Tensor:
    """
...
def compute_metrics(
    ...
    for batch in targets:
        ...
        for image_target in batch:
            ...
            boxes = conve***REMOVED***bbox_yolo_to_pascal(boxes, image_target["orig_size"])
