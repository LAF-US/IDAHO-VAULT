---
source: "https://docs.github.com/en/code-security/tutorials/secret-scanning-partner-program"
author:
published:
created: 2026-08-12
---
...
![Diagram showing the process of scanning for a secret and sending matches to a service provider's verify endpoint.](https://docs.github.com/assets/cb-89330/mw-1440/images/help/security/secret-scanning-flow.webp)
...
To get the enrollment process started, email [secret-scanning@github.com](mailto:secret-scanning@github.com).
...
- A regular expression which finds the secret type. We recommend you are as precise as possible, because this will help reduce the number of false positives. Some best practices for high quality, identifiable secrets are:
	- A uniquely defined prefix
		...
		- A 32-bit checksum
	![Screenshot showing the breakdown of a secret into a prefix and a 32-bit checksum.](https://docs.github.com/assets/cb-18925/mw-1440/images/help/security/regular-expression-guidance.webp)
...
Send this information to [secret-scanning@github.com](mailto:secret-scanning@github.com).
...
We collect feedback on the validity of the detected individual secrets in partner responses. If you wish to take part, email us at [secret-scanning@github.com](mailto:secret-scanning@github.com).
