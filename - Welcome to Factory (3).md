...
![Droid in IDE](https://mintcdn.com/factory/R2VpJ_0BSoOPETrh/images/product-image.png?w=2500&fit=max&auto=format&n=R2VpJ_0BSoOPETrh&q=85&s=d83e48dc93913578571f05016b7a9e49)
...
## [CLI](https://docs.factory.ai/cli/getting-started/quickstart)

Get started with our CLI.

## [Web](https://docs.factory.ai/web/getting-started/overview)

Explore our web interface.

## Quick links

## [IDE Extension](https://docs.factory.ai/cli/configuration/ide-integrations)
...
## [Guides](https://docs.factory.ai/guides/building/droid-exec-tutorial)
...
## [Support](mailto:support@factory.ai)
