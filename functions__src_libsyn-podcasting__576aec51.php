...
function libsynActionsAndFilters() {
	...
	add_action( 'wp_ajax_nopriv_libsyn_check_url', 'Libsyn\\Ajax::checkAjax' );
	...
	add_action( 'wp_ajax_nopriv_libsyn_create_new_post', 'Libsyn\\Service\\Importer::createPostAjax' );
	...
	add_action( 'wp_ajax_nopriv_libsyn_create_metadata', 'Libsyn\\Service\\Importer::createMetadataAjax' );
	...
	add_action( 'wp_ajax_nopriv_libsyn_add_player', 'Libsyn\\Service\\Importer::addPlayerAjax' );
	...
	add_action( 'wp_ajax_nopriv_libsyn_run_import', 'Libsyn\\Service\\Importer::importAjax' );
...
function libsyn_default_register_scripts() {
	...
	wp_register_script( 'libsyn-imports', plugins_url(LIBSYN_DIR . '/lib/js/libsyn/imports.js'), array( 'wp-i18n' ), false, true );
