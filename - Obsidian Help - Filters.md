---
title: "Filters"
source: "https://obsidian.md/help/web-clipper/filters"
author:
published:
created: 2026-05-04
description: "Filters - Obsidian Help"
tags:
  - "clippings"
---
Filters allow you to modify [variables](https://obsidian.md/help/web-clipper/variables) in [Web Clipper templates](https://obsidian.md/help/web-clipper/templates). Filters are applied to variables using the syntax `{{variable|filter}}`.

- Filters work for any kind of [variable](https://obsidian.md/help/web-clipper/variables) including `prompt`, `meta`, `selector`, and `schema` variables.
...
Apply [Basic formatting syntax](https://obsidian.md/help/syntax) and [Advanced formatting syntax](https://obsidian.md/help/advanced-syntax) to text.
...
Creates a [callout](https://obsidian.md/help/callouts) with optional parameters: `{{variable|callout:("type", "title", foldState)}}`
...
Converts strings, arrays, or objects into Markdown link syntax (not to be confused with [wikilink](https://obsidian.md/help/web-clipper/filters#%60wikilink%60)).
...
Converts an array or array of objects into a [Markdown table](https://obsidian.md/help/advanced-syntax#Tables):
...
Converts strings, arrays, or objects into Obsidian [wikilink](https://obsidian.md/help/link-notes) syntax.
...
Process HTML content and convert HTML to Markdown. Note that your input [variable](https://obsidian.md/help/web-clipper/variables) must contain HTML content, e.g. using `{{fullHtml}}`, `{{contentHtml}}` or a `{{selectorHtml:}}` variable.

### markdown

Converts a string to an [Obsidian Flavored Markdown](https://obsidian.md/help/obsidian-flavored-markdown) formatted string.
