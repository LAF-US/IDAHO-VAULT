...
class Importer extends \Libsyn\Service {
	 ...
	 *
	 * @since 1.2.2.7
	 * @return void JSON output int post_id success and false error
	 */
	 ...
	 *
	 * @since 1.2.2.7
	 * @return void JSON output boolean
	 */
	...
	public static function importAjax() {
		...
		if ( intval($urlParams['libsyn_run_import']) === 1 ) {
			...
			// $libsynFeedUrl = get_user_option('libsyn-podcasting-feed_import_libysn_feed'); /* @deprecated 1.2.2.7 */
