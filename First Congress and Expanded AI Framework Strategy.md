# First Congress and Expanded AI Framework Strategy
...
| :--- | :--- | :--- |
| **AutoGen** | **The Conversational Limb** | Best for autonomous code generation and debating agents. Use for "Wild" or "Gossip" phases where agents self-correct through dialogue [5] [6]. |
| **LangSmith** | **The Observability Plane** | The "Book of Records" for the vault. Provides tracing, monitoring, and evaluation across all frameworks (CrewAI, LangGraph, etc.) [7]. |
| **OpenAI Swarm** | **The Pattern Library** | An educational reference for stateless handoffs. Use as a blueprint for explicit agent-to-agent protocols [8]. |
...
- [4] `IDAHO-VAULT/!/SIGNALS/WITNESS-ABHORSEN-2026-05-18-THE-CITY-IS-STILL-AHEAD.md`
- [5] AutoGen Documentation. Microsoft, 2025.
- [6] `IDAHO-VAULT/BIG IFS — UNIFIED SWARM.md`
- [7] LangSmith Observability Platform. LangChain Inc., 2024.
- [8] `IDAHO-VAULT/OpenAI Swarm.md`
- [9] `IDAHO-VAULT/Factory.md`
- [10] `IDAHO-VAULT/!/REPORT-CROSS-FRAMING-TOOL-LANE-DRAFTS-2026-04-17.md`
- [11] `IDAHO-VAULT/!/SENIOR-GAME-DEV-NOTE-CONNECTOR-POSTURE-2026-04-16.md`
