...
[mailing list for discussion about Markdown](http://six.pairlist.net/mailman/listinfo/markdown-discuss). Any topic related to Markdown — both its formatting syntax and its software — is fair game for discussion. Anyone who is interested is welcome to join.
