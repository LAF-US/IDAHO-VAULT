...
As online materials grow more [fragile and prone to disappearance](https://archive.org/details/vanishing-culture-report/page/65/mode/2up), the Internet Archive’s Wayback Machine has been critical in making “lost” web pages available – recently celebrating archiving over a [trillion pages](https://blog.archive.org/trillion/).

As we’ve [previously written about on this blog](https://blog.archive.org/2023/10/09/from-fake-news-to-open-data-studying-the-histories-of-digital-media-using-the-wayback-machine/), the Wayback Machine is an important resource for our work as media researchers, helping us to trace histories of digital media objects (for example, changes in [ad tracker signatures of viral “fake news” sites](https://publicdatalab.org/projects/fake-news/) over time).

We are also interested in how others use web archives [across fields](https://www.are.na/jonathan-gray/web-archivery), and what we can learn from each other.

In this piece we draw on the [Internet Archive’s News Stories](https://archive.org/about/news-stories) collection to surface practices and use cultures of the Wayback Machine amongst journalists and media organisations. We analysed a dataset of about 8,600 news articles, assembled by the IA via daily Google News keyword searches since 2018.
...
Shifting political alliances are a common driver of online footprint erasure. Deleted tweets have revealed past critics in current allies ([here](https://edition.cnn.com/kfile-bernie-moreno-ohio-criticized-trump-deleted-posts/index.html) and [here](https://www.politico.com/news/2020/02/21/grenell-trump-critic-116648)), and current career aspirations were juxtaposed with earlier conflicting stances in personal blogs and websites ([here](https://edition.cnn.com/2024/09/17/politics/jd-vance-delete-2012-blog-post-attacking-gop-anti-immigrant-rhetoric/index.html), [here](https://www.huffingtonpost.co.uk/entry/mike-johnson-wife-website-homosexuality-bestiality-incest_n_653fd7a9e4b0ae2dc0b49d17), [here](https://www.cosmopolitan.com/entertainment/a20145547/meghan-markle-lifestyle-blog-tig-facts-photos/) and [here](https://www.forbes.com/sites/mollybohannon/2024/02/26/trump-ally-kenneth-chesebro-hid-private-social-media-account-from-investigators-report-says/?sh=59e0dbac5c5c)).
...
For example, an investigation into a [set of broken URLs](https://www.politifact.com/article/2022/mar/17/how-broken-urls-helped-fuel-unfounded-conspiracy-t/) on a government website revealed that the pages themselves had not been removed, but the links pointed to outdated servers, creating a false impression of secrecy that sparked a conspiracy theory.

In another case, a major [technical glitch](https://www.premiumtimesng.com/news/headlines/510420-major-glitch-takes-down-multiple-nigerian-govt-websites.html?tztc=1) took multiple Nigerian government websites offline, cutting off access to official information and showing how even unintentional failures can undermine transparency.
...
For example, during a bushfire crisis in Australia, archived pages showed that a key policy statement by the Greens party was [left untouched](https://factcheck.afp.com/australian-bushfires-disinformation-spreads-about-greens-party-policy-backburning), despite a disinformation campaign claiming to the contrary.

Similarly, a social media account circulated as having been reactivated under a new wave of laissez-faire moderation was, in fact, [never suspended](https://www.thedailybeast.com/no-kanyes-twitter-account-hasnt-been-reactivatedbecause-it-was-never-taken-down/).
...
In several reported cases, users raced to preserve spaces such as a [long-running forum](https://techcrunch.com/2023/01/31/stripperweb-forum-shut-down/) for sex workers, a [16-year-old Q&A](https://www.independent.co.uk/tech/yahoo-answers-shut-down-b1827328.html) site, a [meme-sharing platform](https://www.vice.com/en/article/ytmnd-has-shut-down-for-good/), and a [free music library](https://www.spin.com/2018/11/wfmus-free-music-archive-shut-down/).

Archiving web pages can become part of the story.

\*\*\*

These are some of the ways we’ve noticed journalists using web archives – and there are many more! If you know of other interesting examples, we’d [love to hear from you](mailto:contact@publicdatalab.org).
