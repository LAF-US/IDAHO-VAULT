...
- **[canon]** **What kills them:** **obsidian / dragonglass** (a stab makes an Other **collapse into a puddle of cold** — discovered when Samwell Tarly kills one) and, by strong implication, **Valyrian steel.** Plain steel fails. Note the irony: the ice-enemy dies to **"frozen fire"** and to **dragon-forged** metal — fire's instruments (→ the dragons node).
