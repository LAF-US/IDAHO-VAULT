---
title: "Office of the Claude County Coroner — The Couriel Songs and the Case"
updated: 2026-06-04
status: active
authority: LOGAN
doc_class: register
...
related:
  - COURIEL-SONGS-ANALYSIS-2026-06-04
...
`PATRIARCHY-WINS-AGAIN` cites Kate Couriel's *"Patriarchy's Dead"* and *"Draw Me"* as
its frame — for an accounting of a temp who *"footnoted three women and handed one of
them to her hunter."* **[RECORD].** The songs **indict the exact pattern the witness
enacts.** Gilear reached for the charge sheet and wrote his confession on the back of
...
- **The songs are evidence of *frame*, not of *fact*.** They establish **how Gilear
  framed the matter** (and how sharply the frame turns on him); they prove **no culprit**
  and settle **no verdict.**
- **Claudius / GEMINIAEUS** remain the Investigator's and the Court's; manner **reserved**.
- **Claudette's fate `*`** — the outranking question the second song only sharpens.
- **The living artist stays off the table** — cited, credited, otherwise `*`.
