...
| **Master of Ships** | the royal fleet (admiral) |
| **Master of Whisperers** | the spymaster — informants across the realm, the Free Cities, and beyond |
| **Grand Maester** | the **Citadel's** representative and adviser (→ the Citadel node) |
| **Lord Commander of the Kingsguard** | head of the white cloaks; sits the council **in the books** |

⚠️ The roster is **not always full** — which seats are occupied varies by reign, and the Lord Commander's attendance is reign-dependent (Barristan Selmy attended under Robert in the books, though Robert often met without him).

## The offices in depth

**[canon]** Each seat = *scope · besetting temptation · holders*:

- **Hand of the King** — *runs the realm*: commands armies, drafts law, sits the throne and small council in the king's stead. **Temptation:** to become the *real* king behind a weak one. Jon Arryn (steady) → Ned Stark (honest, doomed) → **Tywin Lannister** (ruled in all but name), with **Tyrion** as acting Hand during the Blackwater.
- **Master of Coin** — *the treasury and crown finances*. **Temptation:** to turn the realm's money into a **private web** — debt, patronage, leverage. **Petyr "Littlefinger" Baelish** made the office a ladder.
- **Master of Whisperers** — *the spymaster* ("little birds" across the realm and the Free Cities). **Temptation:** to answer to **no one** and serve your own private definition of "the realm." **Varys.**
...
- **Littlefinger (Coin)** — runs the crown into debt (to the Iron Bank, the Tyrells, and *himself*), keeps brothels as an intelligence-and-blackmail network, and treats disorder as opportunity ("chaos is a ladder") — climbing from a minor seat to Lord of Harrenhal and the Vale.
- **Varys (Whisperers)** — serves his **own** candidate and his own idea of the realm's good, answerable to none; in the books he plays a deep game around a hidden claimant.
- **Pycelle (Grand Maester)** — the **chain captured by a house**: feigned senility, real Lannister service — the dual-loyalty corruption made flesh.
- **Aurane Waters (Ships)** — the office **walking away with the asset**: handed the rebuilt royal fleet, he simply **sails off with it.** The seat captured wholesale.

**[reading]** Vault rhyme: *capture* is the agent **assuming standing through its own narrative** and serving itself inside a scoped grant; the **Master of Whisperers** is the uncontrolled information-agent; **Aurane Waters** is the runaway process that **absconds with the very resource it was scoped to steward.**

## How it works

- **[canon]** The **king — or, in his absence, the Hand — presides.** In a **regency or royal minority**, the council (often with a named regent and the Hand) effectively **rules the realm.**

## Notable holders (main series)
...
**[reading]** The small council is the **operating layer of the empty office** (→ the Empty Office note): the throne holds the *belief*; the council does the *governing*. The **Hand** is the office where a strong man can rule in a weak king's name (Tywin through Joffrey) — power exercised through delegated, recallable seats. Real-world parallel: a medieval **privy council** / a cabinet of ministers.

## Cross-references & sources

**This vault:** `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Citadel-2026-06-03]]`, `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Kingsroad-2026-06-03]]`, `[[RESEARCH_A-Song-of-Ice-and-Fire-Geography-and-Politics-2026-06-01]]`, `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Empty-Office-2026-06-02]]`, `[[RESEARCH_A-Song-of-Ice-and-Fire-The-Maesters-and-the-Citadel-2026-06-02]]`.

**Canon (search-extracted awoiaf; 403 on direct fetch):** [Small council](https://awoiaf.westeros.org/index.php/Small_council) · [Hand of the King](https://awoiaf.westeros.org/index.php/Hand_of_the_King) · [Master of whisperers](https://awoiaf.westeros.org/index.php/Master_of_whisperers) · [Jon Arryn](https://awoiaf.westeros.org/index.php/Jon_Arryn)
