...
[Schnelleinstieg](https://qahl-der-wahl.de/walkthrough.php)

Fragen auswählen oder selbst stellen & Antworten bewerten

[Fragen](https://qahl-der-wahl.de/curated_questions.php)

Fragen gewichten

[Meine Wahl](https://qahl-der-wahl.de/user_area.php)

Auswertung erstellen lassen

[Auswertung](https://qahl-der-wahl.de/evaluation.php)
...
Sie können »qahl« ohne [Registrierung](https://qahl-der-wahl.de/opcodecms/modules/users/user_register.php) nutzen, Ihre Daten sind dann jedoch an Ihre Browsersitzung gebunden.
...
[Ausgewählte Fragen](https://qahl-der-wahl.de/curated_questions.php) [Beliebte Fragen](https://qahl-der-wahl.de/popular_questions.php) [Fragen durchsuchen](https://qahl-der-wahl.de/question.php?search=1) [Eigene Frage stellen](https://qahl-der-wahl.de/question.php)
...
Falls Sie Vertreter einer Partei sind, die nicht berücksichtigt wurde, und uns Ihre Programminhalte in geeigneter Form zur Verfügung stellen möchten, [kontaktieren Sie uns bitte](https://qahl-der-wahl.de/contact.php).
