...
doc_class: sources
status: filed
subject: Oz research sources for Baum versus Maguire comparison
tags:
  - sources
  - oz
  - baum
...
# Sources - Oz: Baum vs Maguire - 2026-06-03

## Scope

Source note for a short comparison of L. Frank Baum's Oz and Gregory
Maguire's revisionist Oz. This note records sources used and short observations.
It is not doctrine.

## Local Vault Anchor

1. `!/OZ-COSMOLOGY-DOCTRINE-v1-2026-05-21.md`
   - Used for the Vault's existing formulation:
     - Baum asks: what is the structure?
     - Maguire asks: how did it get this way, and who benefits?
   - Also used for the existing distinction between the Baum Wizard as
     redeemable humbug and the Maguire Wizard as structurally complicit.
...
- Baum's Oz is structurally legible and restoration-oriented.
- Maguire's Oz is politically suspicious and tragedy-oriented.
- Baum's Wizard can be a humbug and still become useful within legitimate
  order.
- Maguire's Wizard is not merely exposed; he is implicated in a system of
