...
See [Repository Setup](https://docs.openhands.dev/openhands/usage/customization/repository) for details.
...
- **Highly Repetitive Tasks:** These are tasks that need to be done over and over again, but nobody really wants to do them. Some good examples include code review, improving test coverage, upgrading dependency libraries. In addition to having clear success criteria, you can create “ [skills](https://docs.openhands.dev/overview/skills) ” that clearly describe your policies about how to perform these tasks, and improve the skills over time.
