...
080101 Registration of Post-Secondary & Proprietary Schools – schools that provide training but not a degree, schools that provide degrees but are not public

080202-006 Processing certification of teachers, pays investigating ethics violations

080202-07503 Fingerprinting, based on cost of processing
...
Non-renewed rules were redundant with statute & board policy respectively

Expire 55.01.01 – CTE Administrative rules, leadership, assisting local agencies, references 02 section on terminating programs

Expire 55.01.02 – terminating programs, redundant with board policies

Renew 55.01.03 - Governs what qualifies as CTE school

ADDITIONAL DOCKET later in the session that would replace this section, redefining funding for CTE schools

Renew 55.01.04 - Two grant programs

Enrollment FTE Temporary Rule – Discuss today, feedback tomorrow
...
Written by State Board last year, this year’s enrollment numbers based on it

For now, isn’t affecting funding, but collecting data to be able to assess effects when/if that change is made.

Numbers will be turned in by school districts in Oct & Nov. Board will be able to review at Feb meeting
...
Engaged with other state systems – Washington has been enrollment based for several years. Said can’t be done by course, has to be done by hours.

Tomorrow some superintendents and business officers will testify, review their numbers and concerns

ISC 33.10.27 set out enrollment reporting criteria.
...
Fractionalizes students that are taking courses from different schools. How to split funding between schools with different course variables.

“If every student was at one school, if every district had the same courses, the math would be easy” (not exact quote. 9:47am)

In normal circumstances, they ask for temporary rules to be extended. With this rule, they want the committees to provide feedback so this year they are collecting the correct data and meeting legislative intent.
...
Would prefer a messy simple process to a messy complicated process (lol)

Subsection A (1 FTE) – majority of students: one LEA, minimum of hours

Subsection B (<1 FTE) – part time (taking a few classes, maybe homeschooled)

Subsection C (1 FTE) – students who are split between schools

Subsection D (>1 FTE) – students who are between schools, taking total to split proportionally

How is the data collection going so far? Data is being reported already, looking to use it in a new way. Want to improve quality of data without overburdening districts.

Districts were concerned they would be providing a bunch of data and not know how it was going to turn out.

Dept has created a tool for districts to look at their data, student level info, fractionalization, which school gets other fractions.

As of Dec all districts had submitted their reporting.

Districts build schedules before the end of the previous year. This lets them check their minutes per week, etc.
