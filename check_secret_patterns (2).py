...
PUBLIC_EMBED_ALLOW_PATTERNS = {
    "google_api_key": (
        ...
        # Maps JS embed tile server. The key in these URLs is a referrer-restricted
        # public client key captured inside clipped third-party web pages — the same
        # public-by-design class as the embed/staticmap URLs above. Added 2026-08-05.
        re.compile(r"https://maps\.googleapis\.com/maps/vt\?"),
    ),
