---
source: "https://pketh.org/how-kinopio-is-made.html"
author:
...
> I’m tired of [technology](https://pketh.org/why-software-is-slow-and-shitty.html). I’m leaving to do something *real* like sculpt clay, work wood, herd sheep, and grow vegetables.
...
![alt text needed](https://pketh.org/images/2020/porco-rosso-engine.jpg)
...
![alt text needed](https://pketh.org/images/2020/architecture.png)

[Kinopio Architecture and Costs](https://kinopio.club/kinopio-architecture-and-costs-JOGXFJ0FEMpS3crbh6U9k) shows the complete system
...
<video controls="" width="420" height="232"><source src="https://pketh.org/images/2020/edit-user-state.mp4"></video>
...
![alt text needed](https://pketh.org/images/2020/api-docs.png)

[Kinopio API Docs](https://help.kinopio.club/api) are also public so that developers can make custom integrations and tools
...
![alt text needed](https://pketh.org/images/2020/assembly.png)

[(Source)](https://www.are.na/block/3753956)
...
![alt text needed](https://pketh.org/images/2020/loading-space.png)
...
![alt text needed](https://pketh.org/images/2020/cappuccino.png)
