...
The first examples of this genre can be traced back to the 1960s when video terminals were quite expensive. The most successful ones from the time were Star Trek, Lunar Lander and The Oregon Trail.

  

![Star Trek game](https://cdn.kanoapps.com/kanoplay/articles/text-based-rpg-1.webp) (Image Credit: [The Register.co.uk](https://www.theregister.co.uk/2013/05/03/antique_code_show_star_trek/))

  

  

In the middle of the 1970s, video terminals became much more affordable. Most people were intrigued by the idea of artificial intelligence and lots of people were experimenting with video terminals.

  

Many text-based games were created in colleges at this time. The majority of these games were based on the [J. R. R. Tolkien's](https://en.wikipedia.org/wiki/J._R._R._Tolkien) novels and the famous table-top game, [Dungeons & Dragons](https://en.wikipedia.org/wiki/Dungeons_&_Dragons).
...
The first text-based adventure game ever created was [Colossal Cave Adventure](https://en.wikipedia.org/wiki/Colossal_Cave_Adventure). It was developed by [Will Crowther](https://en.wikipedia.org/wiki/William_Crowther_\(programmer\)) between 1975-1977. The game takes place in a cave that is allegedly filled with wealth.

  

![Gameplay screenshot of the text based game Colossal Cave Adventure](https://cdn.kanoapps.com/kanoplay/articles/text-based-rpg-2.webp) (Image Credit: [Wikipedia](https://en.wikipedia.org/wiki/Colossal_Cave_Adventure))

  

  

The game was inspired by mainly Dungeons & Dragons. The interesting thing is the fact that Will Crowther created Colossal Cave Adventure only two years after the launch of Dungeons & Dragons. It usually takes more than two years to inspire someone to create something based on your product. Kudos to the legendary Dungeons & Dragons!

  

![Another gameplay screenshot of the text based game Colossal Cave Adventure](https://cdn.kanoapps.com/kanoplay/articles/text-based-rpg-3.webp) (Image Credit: [Wikipedia](https://en.wikipedia.org/wiki/Colossal_Cave_Adventure))

  

  

One of the most fascinating things about Colossal Cave Adventure was the conversational tone of the program's answers. This was something that was not common at the time and it really grabbed attention.
...
Another early example was [Zork](https://en.wikipedia.org/wiki/Zork). It was launched in the late 1970s and it was of course inspired by Colossal Cave Adventure.

  

![Gameplay screenshot of the text based game Zork](https://cdn.kanoapps.com/kanoplay/articles/text-based-rpg-4.webp) (Image Credit: [Spencer Frum](https://blogs.iac.gatech.edu/sfrum1102/2015/03/27/diversity-in-gaming-a-juxtaposition-of-zork-and-elegy-for-a-dead-world/))

  

  

Zork was a more advanced game compared to its predecessor because the quality of the storytelling was better and the commands were more sophisticated.
...
In the beginning, it was only available on the University of Essex network on weekends and between 2 AM and 8 AM on weekdays. Later on, the university merged its internal network to [ARPANet](https://en.wikipedia.org/wiki/ARPANET) and MUD turned into the first Internet multiplayer online role-playing game in 1980.
...
![Jobs section of the text based game Mob Wars](https://cdn.kanoapps.com/kanoplay/articles/text-based-rpg-5.webp) (Image Credit: [KanoPlay.com](https://www.kanoplay.com/la_cosa_nostra?kpv=info))

  

  

In the beginning, text based games were created due to limitations. It was the only option. However, the fact that technology is advancing rapidly doesn't change the joy we are getting from these old-school games.

  

No matter how advanced technology gets, many people will keep playing text-based games. Thankfully, [some successful games](https://www.kanoplay.com/la_cosa_nostra?kpv=info) were able to maintain the same old school vibe and still continuously get updated with new features.
...
We think that text based RPG and MMORPG will be around for a long time. According to the Guardian, [social media shortens our attention span](https://www.theguardian.com/society/2019/apr/16/got-a-minute-global-attention-span-is-narrowing-study-reveals) and takes our ability to focus on one thing. This situation makes us crave for long-term games even more. That is why the demand is getting bigger for online RPG games such as [Mob Wars: La Cosa Nostra](https://www.kanoplay.com/la_cosa_nostra?kpv=info&t_1=blog&t_2=text-rpg) every year.