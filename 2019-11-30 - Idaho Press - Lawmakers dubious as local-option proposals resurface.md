...
Bannock County Commissioner Terrel Tovey told the legislative panel, “About 85 to 90% of all county functions are requirements of the state.”
...
However, he added, “The question becomes: What’s the threshold? Is it two-thirds, 60%, 50%? Constitutionally, to take on debt, it’s two-thirds.”
...
Idaho allows for local hotel taxes if local voters form a taxing district called an auditorium district. The state currently has three of those in greater Boise, Idaho Falls and Pocatello/Chubbuck. A group of volunteers in Nampa is working to [put an auditorium district up for a vote next May](https://www.idahopress.com/news/local/2cscoop/nampa-volunteers-hope-to-get-auditorium-district-on-the-ballot/article_8839a530-1d8b-582a-abd7-29eda8e64180.html).
