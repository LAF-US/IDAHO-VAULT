---
title: "Self-Improving AI Agents | Meta"
...
created: 2026-06-11
description: "HyperAgents by Meta Research: self-referential AI agents that unify task and meta agents for metacognitive self-modification. Open-source DGM-H framework."
date created: Thursday, June 11th 2026, 6:01:28 pm
date modified: Thursday, June 11th 2026, 6:01:43 pm
---
...
`# HyperAgents Repository Structure agent/           # Foundation model interfaces (LLM, tools)   base_agent.py    # AgentSystem base class   llm.py           # LLM API abstractions   llm_withtools.py # Tool-augmented chat interface   tools/           # Available tool implementations  domains/         # Multi-domain task implementations   polyglot/        # Code patching (Exercism repos, 6 languages)   paper_review/    # Academic paper accept/reject prediction   genesis/         # Robotics reward design (Genesis simulator)   imo/             # Olympiad math grading (IMO-GradingBench)   balrog/          # Game-playing evaluation domain   search_arena/    # Search task domain  analysis/        # Plotting and analysis scripts baselines/       # Baseline comparison implementations utils/           # Shared utilities (docker, git, logging)  meta_agent.py    # Meta agent: recursively self-improves the codebase task_agent.py    # Task agent: solves a given task and returns predictions generate_loop.py # Main entry point for the DGM-H algorithm ensemble.py      # Ensemble logic across archive members select_next_parent.py # Parent selection from archive`
...
### [HyperAgents DGM-H Architecture Explained](https://hyperagents.agency/hyperagents-architecture-dgm-h)
...
### [Meta Agent Self-Modification in HyperAgents](https://hyperagents.agency/hyperagents-meta-agent-self-modification)
...
### [HyperAgents Task Agent: Design and Implementation](https://hyperagents.agency/hyperagents-task-agent-implementation)
...
### [HyperAgents on Polyglot Programming Tasks](https://hyperagents.agency/hyperagents-polyglot-code-domain)
...
### [HyperAgents for Academic Paper Review](https://hyperagents.agency/hyperagents-paper-review-domain)
...
### [HyperAgents in Robotics Reward Function Design](https://hyperagents.agency/hyperagents-robotics-reward-design)
...
### [HyperAgents for Olympiad Math Grading (IMO)](https://hyperagents.agency/hyperagents-imo-grading-math)
...
### [Cross-Domain Transfer of Improvement Capability](https://hyperagents.agency/hyperagents-cross-domain-transfer)
...
### [Open-Ended Exploration and Archive Mechanisms](https://hyperagents.agency/hyperagents-open-ended-exploration)
...
### [HyperAgents vs. Darwin Godel Machine (DGM)](https://hyperagents.agency/hyperagents-vs-dgm-comparison)
...
### [Emergent Engineering in HyperAgents](https://hyperagents.agency/hyperagents-emergent-capabilities)
...
### [HyperAgents Safety, Risk, and AI Governance](https://hyperagents.agency/hyperagents-safety-governance)
...
### [AI Agent Taxonomy: From ReAct to HyperAgents](https://hyperagents.agency/hyperagents-agent-taxonomy)
...
### [Benchmarks for Self-Improving Agent Systems](https://hyperagents.agency/hyperagents-benchmarks-evaluation)
...
### [HyperAgents Setup and Quickstart Guide](https://hyperagents.agency/hyperagents-setup-quickstart)

Environment setup, API key configuration (OpenAI, Anthropic, Google), Docker image building, initial agent bootstrapping, and running generate\_loop.py.
