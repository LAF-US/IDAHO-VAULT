...
date modified: Sunday, April 5th 2026, 5:45:00 pm
---
...
| **MCP Server Outage** | Janitor | **BLOCKED** | — | **CRITICAL: Cursor MCP servers (Playwright, GitHub, etc.) reporting as `Stopped`.** |
